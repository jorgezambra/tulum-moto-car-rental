...
// Reviews imported from Google Maps - Renta de Autos Y Motos Tulum
// Profile photos from Unsplash matched to review context
export const reviews: Review[] = [
  {
    id: 'review-1',
    name: 'Juan Jose Monsalve',
    rating: 5,
