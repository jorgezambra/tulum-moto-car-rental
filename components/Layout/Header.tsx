    ...
    <header className="bg-white shadow-md fixed top-0 left-0 right-0 z-50 w-full">
      <div className="w-full max-w-7xl mx-auto px-2 sm:px-4 py-3 sm:py-4">
        <div className="flex items-center justify-between w-full">
          <Link href="/" className="text-xl sm:text-2xl font-bold text-turquoise whitespace-nowrap flex-shrink-0">
            Tulum OnWheels
          </Link>
          <div className="flex items-center flex-1 justify-end gap-6 xl:gap-8">
            ...
            <button 
              onClick={toggleMenu}
              className="lg:hidden ml-2 p-2 hover:bg-gray-100 rounded-lg transition-colors"
            ...
            >
              <div className="flex flex-col gap-4 pt-4 border-t border-gray-200 mt-4">
                <Link
                  href="/"
                  onClick={closeMenu}
                  className="text-base text-gray-700 hover:text-turquoise transition-colors py-2"
                >
                  {t('nav.home')}
                </Link>
                <Link
